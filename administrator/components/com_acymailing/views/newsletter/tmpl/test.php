...
?><form action="<?php echo JRoute::_('index.php?option=com_acymailing&ctrl='.$this->ctrl); ?>" method="post" name="adminForm"  id="adminForm" autocomplete="off" onsubmit="var val = document.getElementById('message_receivers').value; if(val != ''){ setUser(val);}">
