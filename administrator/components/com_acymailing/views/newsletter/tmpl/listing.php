				...
				<tr class="<?php echo "row$k"; ?>">
					...
					<td>
						...
						if($this->app->isAdmin()){
							...
							?>
							<span class="acyabtestbutton"><a class="modal" rel="{handler: 'iframe', size: {x: 800, y: 590}}" href="<?php echo $urlAbTest; ?>"><img src="<?php echo ACYMAILING_IMAGES; ?>icons/icon-16-acyabtesting.png" alt="<?php echo JText::_('ABTESTING',true) ?>" /></a></span>
						<?php } else{
							echo '<span class="acyabtestbutton" style="margin-right:12px;">&nbsp;</span>';
							}
						 }
