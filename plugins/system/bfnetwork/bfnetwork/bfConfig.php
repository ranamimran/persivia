...
/**
 * Much of this configuration will be moved to the SaaS console in September 2014 as
 * part of the larger infrastructure changes already being trialed in staging env.
 */
...
// Enable Logging
define('_BF_LOG', FALSE); //should always be FALSE
...
// used in bfAuditor    default: TRUE
