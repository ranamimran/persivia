...
final class bfSnapshot
{
    ...
    {
        // Ask Joomla to report through its API
    ...
    {
        $count = 0;
        $folderContents = scandir(JPATH_BASE . '/administrator/components/com_akeeba/backup');
    ...
    private function hastmplogfoldersdefaultpaths()
    {
        ...
        $expectedLogPath = JPATH_BASE . '/logs';
        $expectedTmpPath = JPATH_BASE . '/tmp';

        return (int)($expectedLogPath == $logPath && $expectedTmpPath == $tmpPath);
    }
