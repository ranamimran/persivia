	...
	<fieldset class="adminform acy_subscription_list">
		...
		<div id="acyusersubscription">
			...
			foreach($this->subscription as $row){
				...
				?>
			<div class="<?php echo "row$k $listClass"; ?> acy_onelist"<?php if($this->autolistsString == 'all' || (!empty($this->autolists) && in_array($row->listid, $this->autolists))){ echo ' style="display:none"'; } ?>>
				<div class="acystatus">
