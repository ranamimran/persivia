...
?>
<?php 
if($helper->get('block-extra-class') == " bg-image news_heading_hyper"){
 echo '<h3 class="module-title "><a href="index.php?option=com_content&view=category&layout=blog&id=114&Itemid=783"><span>News & Events</span></a></h3>';
}
?>
